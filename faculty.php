<?php
    ...
    $statement = $db->prepare($query);
    $statement->execute();
    $allFacultyList = $statement->fetchAll(PDO::FETCH_ASSOC);
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <!-- /.dropdown -->
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="logout.php?page=faculty.php"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>';
                              ...
                              <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                  ...
                                  <tbody id="facultyTable">
                                    <?php 
                                        foreach($allFacultyList as $inforesult)
                                        {
                                          echo"<tr>";
                                          if(isset($_SESSION['groupid']))
                                          {
                                ...
                                <div class="infomodal-container">
                                    <h1>Basic Information</h1><br>  
                                        ...
                                        ?>
                                          ...
                                          DOB <input type = "date" name = "dob" value = "<?php echo $inforesult['DOB'];?>" readonly required></br>
